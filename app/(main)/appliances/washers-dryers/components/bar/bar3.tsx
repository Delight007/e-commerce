...
export default function WashingBar3() {
  const item = [
    { name: "Wash Machine", link: "#" },
    { name: "Office For Mac", link: "#" },
    { name: "Washing Machine With Dryers", link: "#" },
    { name: "Dryer", link: "#" },
    { name: "Dryers Machine", link: "#" },
    ...
    { name: "Authomatic Washing Machine", link: "#" },
    { name: "Blower ", link: "#" },
    { name: "G Unit", link: "#" },
  ];
  return (
    <div className="p-[16px] text-[14px] relative group">
      ...
      >
        ...
        {item.map((item, index) => (
          <SwiperSlide key={index} className="!w-auto min-w-[40px]">
