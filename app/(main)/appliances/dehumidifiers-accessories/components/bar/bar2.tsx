...
import DishBrandsMenu from "../dehumidifierBrand";
import DehumidifierBrandsMenu from "../dehumidifierBrand";

const fugazOne = Fugaz_One({ subsets: ["latin"], weight: ["400"] });
export default function DehumidifierBar2() {
  return (
