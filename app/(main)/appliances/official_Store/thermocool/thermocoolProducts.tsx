...
export default function ThermocoolProducts() {
    ...
    async function fetchProducts() {
      try {
        const response = await fetch(
          "/api/brand?page=1&limit=40&brand=Haier Thermocool"
        );
