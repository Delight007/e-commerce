...
import MicrowaveBrandsMenu from "../smallAppliancesBrand";
import SmallAppliancesBrandsMenu from "../smallAppliancesBrand";

const fugazOne = Fugaz_One({ subsets: ["latin"], weight: ["400"] });
export default function SmallAppliancesBar2() {
  return (
