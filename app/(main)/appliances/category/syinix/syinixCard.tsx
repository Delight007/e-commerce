...
const SyinixCard: React.FC<ProductProps> = ({ product }) => {
  const [imageLoading, setImageLoading] = React.useState(true);
  return (
    <div className="group relative w-[180px] h-[245px] bg-white rounded-md  flex flex-col justify-center items-center  mt-2 mb-1 ml-[6px] cursor-pointer  transition-shadow hover:scale-[1.02] duration-300 hover:shadow-[0px_2px_6px_rgba(200,200,200,0.2),0px_-2px_6px_rgba(200,200,200,0.2),2px_0px_6px_rgba(200,200,200,0.2),-2px_0px_6px_rgba(220,220,220,0.2)]">
      <div className="relative w-full h-[170px] flex items-center justify-center ">
        {imageLoading && (
          <div className="w-full h-full absolute animate-pulse rounded-t-md bg-gray-200"></div>
        )}
        <Image
          src={product.image}
          alt={product.name}
