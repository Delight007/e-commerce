...
import DishProductCard from "./bundleProductCard";
...
const CookerProductsList = ({
  ...
  const {
    ...
    queryKey: ["Electric Cooker", page, name], // Include category in the query key
...
export default CookerProductsList;
