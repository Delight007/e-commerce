...
import DishBrandsMenu from "../ovenToasterBrand";
import OvenToasterBrandsMenu from "../ovenToasterBrand";

const fugazOne = Fugaz_One({ subsets: ["latin"], weight: ["400"] });
export default function OvenToasterBar2() {
  return (
