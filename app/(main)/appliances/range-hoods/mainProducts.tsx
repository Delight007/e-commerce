...
import RangeBar1 from "./components/bar/bar1";
import RangeBar2 from "./components/bar/bar2";
import RangeBar3 from "./components/bar/bar3";
import RangeProductsList from "./components/rangeProductList";
    ...
    async function fetchProducts() {
      try {
        const response = await fetch(
          "/api/name?page=1&limit=40&name=Range Hoods"
        );
    ...
    <div>
      <div className="w-[880px] h-auto min-h-[1800px] rounded-md bg-white relative pb-8">
        <div className="w-full h-[60px] ">
          <RangeBar1 totalProducts={totalProducts} />
        </div>
