...
import BinatoneBar1 from "./components/bar/bar1";
import BinatoneBar2 from "./components/bar/bar2";
import BinatoneProductsList from "./components/binatoneProductList";
...
export default function BinatoneProducts() {
    ...
    async function fetchProducts() {
      try {
        const response = await fetch(
          "/api/brand?page=1&limit=40&brand=Binatone"
        );
