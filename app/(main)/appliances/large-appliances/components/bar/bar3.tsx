...
export default function LargeAppliancesBar3() {
  const item = [
    { name: "Household Appliances", link: "#" },
    { name: "home appliances", link: "#" },
    { name: "Large Appliances", link: "#" },
    { name: "Black Friday Large Appliances", link: "#" },
    { name: "Office For Mac", link: "#" },
    { name: "Wash Machine", link: "#" },
    { name: "washing machine", link: "#" },
    { name: "Office Accessories", link: "#" },
    { name: "Dryer", link: "#" },
    { name: "Dryer Machine", link: "#" },
    { name: "Washing Machine With Dryer", link: "#" },
    { name: "washing machine with dryer", link: "#" },
    { name: "automatic wahsing machine", link: "#" },
    { name: "Automatic Wahsing Machine", link: "#" },
