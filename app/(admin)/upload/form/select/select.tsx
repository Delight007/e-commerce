    ...
    <div className="flex flex-col gap-2">
      <div className="flex gap-1 w-full">
        <select
          ...
          className="p-2 border flex-1 shadow-md rounded-md focus:outline-none cursor-pointer"
        >
        ...
        <select
          ...
          className="p-2 border shadow-md flex-1 rounded-md focus:outline-none cursor-pointer"
