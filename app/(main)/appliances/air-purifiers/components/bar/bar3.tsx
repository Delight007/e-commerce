...
export default function PurifierBar3() {
  const item = [
    { name: "Office Heater", link: "#" },
    { name: "Heated Clothing", link: "#" },
    { name: "Gen Cool AC", link: "#" },
    { name: "Anniversary", link: "#" },
    { name: "Home & Kitchen Upgrade", link: "#" },
    { name: "Air Freshener", link: "#" },
    { name: "Air Conditioner Fresh", link: "#" },
    { name: "Heater", link: "#" },
    { name: "Household Air Freshener", link: "#" },
    { name: "Home Decor", link: "#" },
    { name: "Kitchen Heater", link: "#" },
    { name: "Office Accessories", link: "#" },
    { name: "House Vacuum", link: "#" },
    { name: "Pur Filter", link: "#" },
    { name: "Air Conditioner Filter", link: "#" },
