...
export default function VacuumBar3() {
  const item = [
    { name: "home appliances", link: "#" },
    { name: "Vacuum Cooking", link: "#" },
    { name: "House Vacuum", link: "#" },
    { name: "Vacuum Cleaner", link: "#" },
    { name: "Small Vacuum Cleaner", link: "#" },
    { name: "Mini Vacuum Cleaner", link: "#" },
    { name: "Mini Vacuum", link: "#" },
    { name: "Household Appliances", link: "#" },
    { name: "Small Vacuum Cleaner For Car", link: "#" },
    { name: "Car Vacuum Cleaner", link: "#" },
    { name: "Mini Car vacuum Cleaner", link: "#" },
