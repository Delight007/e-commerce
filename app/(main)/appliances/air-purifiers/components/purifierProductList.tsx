...
import BlenderProductCard from "./purifierProductCard";
import DishProductCard from "./purifierProductCard";
...
const PurifierProductsList = ({
  ...
  const {
    ...
    queryKey: ["Purifiers", page, name], // Include category in the query key
...
export default PurifierProductsList;
