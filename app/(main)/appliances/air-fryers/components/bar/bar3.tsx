...
export default function AirpBar3() {
  const item = [
    { name: "Small Air Fryer", link: "#" },
    { name: "Air Fryer For Noodles", link: "#" },
    { name: "Air Fryer For Pancakes", link: "#" },
    { name: "Air Fryer For Pies", link: "#" },
    { name: "Air Fryer For Pork", link: "#" },
    { name: "Small Fryer", link: "#" },
    { name: "Air Fryer For Pork Chops", link: "#" },
    { name: "Air Fryer For Ravioli", link: "#" },
    { name: "Air Fryer For Roasting Nuts", link: "#" },
    { name: "Air Fryer For Samosas", link: "#" },
    { name: "Air Fryer For Shrimp", link: "#" },
    { name: "Air Fryer For Tater Tots", link: "#" },
    { name: "Air Fryer For Veggie Burger", link: "#" },
