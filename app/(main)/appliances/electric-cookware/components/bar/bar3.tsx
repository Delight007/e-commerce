...
export default function CookerBar3() {
  const item = [
    { name: "Household Appliances", link: "#" },
    { name: "Electric Home Appliances", link: "#" },
    ...
    { name: "Dining Lights", link: "#" },
    { name: "Stainless Steel Cookware", link: "#" },
    { name: "Kitchen Lamps", link: "#" },
    { name: "Small Lamps", link: "#" },
    { name: "small Bulb", link: "#" },
    { name: "Small Light Bulbs", link: "#" },
    { name: "Small Light Bulbs For Lambs", link: "#" },
    { name: "Mini Bat", link: "#" },
  ];
  return (
