...
export default function KettleBar3() {
  const item = [
    { name: "Serving Dishes", link: "#" },
    { name: "Dishwasher", link: "#" },
    { name: "Serving Dish", link: "#" },
    { name: "Kitchen Equipment", link: "#" },
    { name: "Food Plate", link: "#" },
    { name: "Plate Drainer", link: "#" },
    { name: "Dish Drainer", link: "#" },
    { name: "Dish Sponge", link: "#" },
    { name: "Magic Eraser Sponge", link: "#" },
    { name: "Foam Cleaner", link: "#" },
    { name: "Foam Sponge", link: "#" },
    { name: "Mini Dishwasher", link: "#" },
    { name: "Small Dishwahser", link: "#" },
    { name: "Glass plate", link: "#" },
    { name: "Cultlery Holder", link: "#" },
  ];
  return (
