...
import AcProductCard from "./AcProductsCard";
...
const AcProductsList = ({
  ...
  const {
    ...
    queryKey: ["Ac-products", page, name], // Include category in the query key
