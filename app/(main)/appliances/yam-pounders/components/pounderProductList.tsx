...
import VacuumProductCard from "./pounderProductCard";
...
const PounderProductsList = ({
  ...
  const {
    ...
    queryKey: ["Yam Pounder", page, name], // Include category in the query key
...
export default PounderProductsList;
