...
import AcProductsList from "./components/AcProductList";
import AcBar1 from "./components/bar/bar1";
import AcBar2 from "./components/bar/bar2";
import AcBar3 from "./components/bar/bar3";
    ...
    async function fetchProducts() {
      try {
        const response = await fetch(
          "/api/name?page=1&limit=40&name=Air Conditioners"
        );
